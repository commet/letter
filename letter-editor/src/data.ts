...
export const defaultConfig: VideoConfig = {
  ...
  audio: {
    ...
    trackBStartSec: 167,                 // 2:47 = A 페이드아웃 종료 (원본 2:40 대비 7s 더 재생)
    crossfadeSec: 4,                     // A 페이드아웃 4s [2:43~2:47]
    trackBGapSec: 1.2,                   // 2:47~2:48.2 살짝 휴지 (호흡 한 번)
    trackBFadeInSec: 5,                  // B 페이드인 5s [2:48.2~2:53.2] — smoothstep 곡선으로 잔잔하게 진입
    volume: 0.30,
    fadeInSec: 1.5,
