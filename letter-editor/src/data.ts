...
export const defaultConfig: VideoConfig = {
  ...
  audio: {
    ...
    trackBStartSec: 163,                 // 2:43 = A 페이드아웃 종료 (뒷부분 3s 더 재생)
    crossfadeSec: 4,                     // A 페이드아웃 4s [2:39~2:43]
    trackBGapSec: 1.2,                   // 2:43~2:44.2 살짝 휴지 (호흡 한 번)
    trackBFadeInSec: 5,                  // B 페이드인 5s [2:44.2~2:49.2] — smoothstep 곡선으로 잔잔하게 진입
    volume: 0.30,
    fadeInSec: 1.5,
